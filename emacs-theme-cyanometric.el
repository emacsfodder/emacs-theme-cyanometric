...
(autothemer-deftheme  cyanometric
 ...
 ((((class color) (min-colors #xFFFFFF))) ;; GUI/24bit only
  ...
  (cyanometric-background-0          "#190700")
  (cyanometric-background-0-soft     "#200500")
  (cyanometric-background-1          "#301000")
  (cyanometric-background-2          "#401000")
  (cyanometric-background-3          "#471000")
  (cyanometric-background-4          "#4F1000")

  (cyanometric-medium                "#DD7400")

  (cyanometric-foreground-0-hard     "#FFFFFF")
  (cyanometric-foreground-0          "#FFE0C0")
  (cyanometric-foreground-0-soft     "#FFA030")
  (cyanometric-foreground-1          "#FF8010")
  (cyanometric-foreground-2          "#F07010")
  (cyanometric-foreground-3          "#E06010")
  (cyanometric-foreground-4          "#D05010")
  ...
  (cyanometric-neutral-red          "#FF9900")
  (cyanometric-neutral-green        "#FF9900")
  (cyanometric-neutral-yellow       "#FF9A03")
  (cyanometric-neutral-blue         "#FFB240")
  (cyanometric-neutral-purple       "#FFB240")
  (cyanometric-neutral-teal         "#FFB050")
  (cyanometric-neutral-orange       "#FF9900")
  (cyanometric-neutral-cyan         "#FFCC80")

  (cyanometric-faded-red            "#FFB259")
  (cyanometric-faded-green          "#B97E40")
  (cyanometric-faded-yellow         "#FFB359")
  (cyanometric-faded-blue           "#A06537")
  (cyanometric-faded-purple         "#FFB059")
  (cyanometric-faded-teal           "#905132")
  (cyanometric-faded-orange         "#BA6D41")
  (cyanometric-faded-cyan           "#BA8141")

  (cyanometric-muted-red            "#FFE1BF")
  (cyanometric-muted-green          "#B9A28A")
  (cyanometric-muted-yellow         "#FFE1BF")
  (cyanometric-muted-blue           "#A08978")
  (cyanometric-muted-purple         "#FFE0BF")
  (cyanometric-muted-teal           "#90776C")
  (cyanometric-muted-orange         "#BA9C8B")
  (cyanometric-muted-cyan           "#BAA48B")

  (cyanometric-background-red       "#190F01")
  (cyanometric-background-green     "#261E13")
  (cyanometric-background-yellow    "#261701")
  (cyanometric-background-blue      "#261B0C")
  (cyanometric-background-purple    "#262019")
  (cyanometric-background-teal      "#261E14")
  (cyanometric-background-orange    "#261600")
  (cyanometric-background-cyan      "#26221E")

  (cyanometric-mid-red              "#BF3000")
  (cyanometric-mid-green            "#894F0F")
  (cyanometric-mid-yellow           "#AF4F00")
  (cyanometric-mid-blue             "#934F0F")
  (cyanometric-mid-purple           "#BF4F0F")
  (cyanometric-mid-teal             "#B04D00")
  (cyanometric-mid-orange           "#BF4200")
  (cyanometric-mid-cyan             "#B25000")

  (cyanometric-delimiter-1          "#FF4F00")
  (cyanometric-delimiter-2          "#E14400")
  (cyanometric-delimiter-3          "#D04000")
  (cyanometric-delimiter-4          "#AA3A00")

  (cyanometric-identifiers-1        "#FF6600")
  (cyanometric-identifiers-2        "#ED5E00")
  (cyanometric-identifiers-3        "#D75600")
  (cyanometric-identifiers-4        "#C14D00")
  (cyanometric-identifiers-5        "#BB4400")
  (cyanometric-identifiers-6        "#FF6600")
  (cyanometric-identifiers-7        "#ED5E00")
  (cyanometric-identifiers-8        "#D75600")
  (cyanometric-identifiers-9        "#C14D00")
  (cyanometric-identifiers-10       "#BB4400")
  (cyanometric-identifiers-11       "#FF6600")
  (cyanometric-identifiers-12       "#ED5E00")
  (cyanometric-identifiers-13       "#D75600")
  (cyanometric-identifiers-14       "#C14D00")
  (cyanometric-identifiers-15       "#BB4400")

  (cyanometric-white                "#FFFFFF")
  (cyanometric-black                "#000000")
  (cyanometric-accent-1             "#FF5A00")
  (cyanometric-accent-2             "#FF6A00")
  (cyanometric-accent-3             "#FF7A00")
  (cyanometric-accent-4             "#FF3A00")
  (cyanometric-accent-5             "#FF4A00")
  (cyanometric-accent-6             "#F72A00")

  (cyanometric-dark-accent-1        "#982F00")
  (cyanometric-dark-accent-2        "#882F00")
  (cyanometric-dark-accent-3        "#782600")
  (cyanometric-dark-accent-4        "#681A00")
  (cyanometric-dark-accent-5        "#581300")
  (cyanometric-dark-accent-6        "#481100"))
