...
Welcome to Emacs Theme Cyanometric! You can contribute to the project in the following ways:
...
1. **Bug reports:** One liner reports are difficult to understand and review.
	...
	3. Maintainers may close unclear issues that lack enough information to reproduce a bug. [Report a bug here](https://github.com/emacsfodder/emacs-theme-cyanometric/issues/new?assignees=&labels=bug&template=bug_report.md).
...
2. **Feature suggestions:** If you feel there is a nice enhancement or feature that can benefit many users, please open a feature request issue.
	...
	4. Maintainers may close unclear feature requests that lack enough information. [Suggest a feature here](https://github.com/emacsfodder/emacs-theme-cyanometric/issues/new?assignees=&labels=enhancement&template=feature-or-change-request.md&title=).
